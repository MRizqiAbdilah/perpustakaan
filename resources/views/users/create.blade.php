...
@section('content')
    <div class="w-full h-[91vh] flex justify-center mt-5">
        <form action="/users" method="post">
            @csrf
            <h1 class="text-2xl font-bold my-4 text-center">Tambah User</h1>
            <div class="form">
            ...
            <div class="form my-5">
                <button type="submit" class=" bg-slate-400 text-center w-full h-12 rounded-xl">Tambah User</button>
            </div>
        </form>
    </div>
@endsection
