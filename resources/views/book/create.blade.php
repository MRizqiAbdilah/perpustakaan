...
@section('content')
    ...
    <div class="w-full h-[91vh] flex justify-center mt-5">
        <form action="/books" method="post" enctype="multipart/form-data">
            @csrf
            <h1 class="text-2xl font-bold my-4 text-center">Tambah Buku</h1>
            <div class="form">
            ...
            <div class="form">
                ...
                <input type="text" name="slug" id="slug" class="input-form text-gray-900 bg-gray-50"
                    value="{{ old('slug') }}" disabled readonly required>
                @error('slug')
                    <div class="text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 mt-[-8px]"
                        role="alert">
                        <span class="font-medium">{{ $message }}
            ...
            <div class="form">
                ...
                <input type="text" name="author" id="author" class="input-form" value="{{ old('author') }}"
                    autofocus>
                @error('author')
                    <div class="text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 mt-[-8px]"
                        role="alert">
            ...
            <div class="form">
                ...
                <input type="text" name="publisher" id="publisher" class="input-form" value="{{ old('publisher') }}"
                    autofocus>
                @error('publisher')
                    <div class="text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 mt-[-8px]"
                        role="alert">
            ...
            <div class="form flex justify-center my-5">
                <button type="submit" class=" bg-slate-400 text-center w-full h-12 rounded-xl">Tambah Buku</button>
            </div>
        </form>
    </div>
    <script>
