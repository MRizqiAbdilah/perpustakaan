...
@section('content')
    <h1 class="text-2xl text-blue-500 px-10 py-5">Laporan</h1>
        ...
        @foreach ($peminjaman as $p)
            <div
                ...
                <a href="/books?user={{ $p->user }}">
                    ...
                    <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Tanggal Kembali : {{ $p->tanggal_peminjaman}}</h5>
                </a>
            </div>
        @endforeach
    </div>
