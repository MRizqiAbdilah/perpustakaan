...
@section('content')
    <div class="w-full h-[91vh] flex justify-center mt-5">
        <form action="/register" method="post">
            ...
            <div class="form my-5">
                <button type="submit" class=" bg-slate-400 text-center w-full h-12 rounded-xl">Register</button>
            </div>
            <p class="text-center">Already Registered? <a href="/login">Login Now!</a></p>
        </form>
    </div>
@endsection
